...
public class NSEIndustriesController {
    ...
    @GetMapping("/get-basic-industries/{industriesId}")
    public ResponseEntity<List<NSEBasicIndustries>> getAllBasicIndustriesForIndustries(@PathVariable Integer industriesId){
        return ResponseEntity.status(HttpStatus.OK).body(nseIndustriesService.getAllBasicIndustriesForIndustries(industriesId));
    }
}
